...
* esse an conflit con dij prefiss antërwiki o nòm dë spassi nominal.",
	...
	'lqt_change_new_thread' => "Sto sì a l'é la revision inissial ëd la discussion.",
	'lqt_change_reply_created' => "Ël [coment $1 a àuta luminosità] a l'é stàit creà an sta revision-sì.",
	'lqt_change_edited_root' => "Ël [coment $1 a àuta luminosità] a l'é stàit modificà an sta revision-sì.",
	'lqt_change_edited_summary' => "Ël somari dla discussion a l'é stàit modificà",
	'lqt_change_deleted' => "[$1 Sta discussion-sì] o soa genitris a l'é stàita scanselà",
	'lqt_change_undeleted' => "Ël [coment anluminà $1] a l'é stàit arcuperà",
	...
	'lqt_change_merged_from' => "Na [$1 arspòsta] a sta discussion-sì a l'é stàita tramudà a n'àutra discussion",
	'lqt_change_merged_to' => "La [$1 arspòsta anluminà] a l'é stàita tramudà da n'àutra discussion.",
	'lqt_change_split_from' => "Na [$1 sotdiscussion] dë sta discussion-sì a l'é stàita dividùa ant le soe discussion",
	'lqt_change_root_blanked' => "Ël test ëd [$1 un coment] a l'é stàit tramudà.",
	'lqt_youhavenewmessages' => "It l'has [$1 mëssagi neuv].",
	'lqt_protectedfromreply' => "Sta discussion-sì a l'é stàita $1 da avèj arspòste.",
	'lqt_protectedfromreply_link' => 'protet',
	'lqt_subject' => 'Soget:',
	'lqt_noreason' => 'Pa gnun-e rason dàite.',
	'lqt_move_placeholder' => "Sta discussion-sì a l'é un segnapòst ch'a ìndica che na discussion, $1, a l'é stàita tramudà da sta pàgina-sì.
Sto spostament-sì a l'é stàit fàit da $2 ël $3 a $4.
La discussion a l'é adess piassà a $5.",
	'lqt_thread_deleted_for_sysops' => "Sta discussion-sì a l'é stàita '''scanselà''' e a l'é mach visibla a j'aministrador.",
	'lqt_thread_deleted' => "Sta discussion-sì a l'é stàita scanselà.",
