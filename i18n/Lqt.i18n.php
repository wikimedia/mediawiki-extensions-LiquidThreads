...
$messages['arz'] = array(
	...
	'lqt_change_reply_created' => 'أُنشئ [$1 التعليق المظلل] فى هذه المراجعة.',
	'lqt_change_edited_root' => 'عُدل [$1 التعليق المظلل] فى هذه المراجعة.',
	...
	'lqt_subject' => 'موضوع:',
	'lqt_noreason' => 'لا سبب معطى.',
	'lqt_move_placeholder' => 'هذا النقاش لحجز المكان ويعنى أن النقاش $1 نُقل من هذه الصفحة.
...
* конфлікт з інтервікі-префіксами або просторами назв.',
	...
	'lqt_summary_notice_link' => 'написати резюме',
...
Ця гілка є частиною $2.',
	...
	'lqt_split_thread' => 'Розділення гілки',
...
Підпис відображається автоматично.',
	'lqt-marked-as-read-placeholder' => 'Гілка $1 була позначена як прочитана.',
	'lqt-change-subject' => 'Змінити тему',
	'lqt-save-subject' => 'Зберегти',
	'lqt-save-subject-failed' => 'Під час спроби зміни теми цієї гілки виникла наступна помилка: $1',
