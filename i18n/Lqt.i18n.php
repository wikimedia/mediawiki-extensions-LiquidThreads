...
Sta discussion-sì a l'é part ëd $2.",
	...
	'lqt_delete_deleted' => "La discussion a l'é stàita scanselà.",
	...
	'lqt_delete_unallowed' => 'It peule pa scanselé discussion.',
	'lqt_delete_show_checkbox' => 'Mosta discussion scanselà',
	'lqt_talkpage_autocreate_summary' => "Pàgina ëd discussion autocreà quand la prima discussion a l'é stàita postà.",
	'lqt_header_warning_big' => 'I të stas modificand na $1.',
	'lqt_header_warning_after_big' => 'Le testà a son për anonsi e rrefassion.
Nopà it peule vorèj $2.',
	'lqt_header_warning_bold' => 'testà ëd pàgina ëd discussion',
	...
	'lqt-older' => 'pi vej',
	'lqt-newer' => 'pi neuv',
	'lqt-searching' => 'Serca discussion',
...
A saran ancó visìbile an sle soe pàgine ëd discussion originaj.
Sta operassion-sì a l'é pa ribaltabla.",
	...
	'lqt-no-new-messages' => 'A-i é pa gnun mëssagi neuv për ti.',
	'lqt-new-messages' => '✒ A-i é ëd mëssagi neuv për ti.',
	'lqt-email-info-undo' => "Arpòrta andré la discussion ch'it l'has pen-e lassà.",
	'lqt-date-info' => "Sto colegament-sì a l'é disabilità përchè it të stas vardand discussion da tute le date.",
	'lqt-newmessages-context' => 'Discussion antera.',
	...
	'lqt-thread-edited-author' => 'Modificà da autor.<br />
Ultima modìfica: $1',
	'lqt-thread-edited-others' => "Modificà da {{PLURAL:$2|n'àutr utent|$2 utent}}.<br />
Ultima modìfica: $1",
	'lqt-header-actions' => 'Assion',
	'lqt_summarize_link' => 'Somarisa',
	'lqt-summarize-intro' => 'Për piasì somarisa la discussion sota ant na box ëd modìfica.
It peule dovré minca test wiki an tò somari.
Quand it finisse, sgnaca "{{int:savearticle}}".',
	'lqt-thread-split' => 'Divid an discussion neuve',
	...
	'lqt-delete-parent-warning' => "Sta sì a l'é na discussion a àut livel con arspòste.
Soe arspòste a saran ëdcò scanselà automaticament.
Për evité sòn sì, dividje da sta discussion-sì prima dë scanselela.",
	'lqt-delete-parent-deleted' => 'Scanselà la discussion genitris ($1)',
	'lqt-delete-replies-done' => "Tute j'arspòste a sta discussion-sì a son ëdcò stàite scanselà.",
	'lqt-movethread' => 'Tramuda',
	'lqt-menu-trigger' => 'Pi',
	'lqt-newmessages-from' => 'Da $1',
	'lqt-hot-topics' => 'Argoment càud',
	'lqt-add-reply' => 'Gionta na arspòsta',
	'lqt_rc_new_discussion' => 'manda na discussion neuva, "$1"',
	'lqt_rc_new_reply' => 'mandà na arspòsta a "$1"',
	'right-lqt-split' => 'Divid discussion',
	'right-lqt-merge' => 'Uniss discussion',
	'lqt-thread-merge' => "Uniss ant n'àutra discussion",
	'lqt-thread-merge-to' => 'Uniss a sta discussion-sì',
	'lqt_merge_thread' => 'Uniss discussion',
	'lqt-thread-merge-source' => 'Discussion sorziss:',
	...
	'lqt-log-name' => 'Registr ëd discussion',
	...
	'lqt-log-action-resort' => "modificà l'ordinament ëd [[$1]]. Cangià ciav d'ordinament da $2 a $3",
	'lqt-preference-notify-talk' => "Mandme n'e-mail për j'arspòste a na discussion ch'i ten sot euj",
	'lqt-preference-watch-threads' => "Varda discussion che i creo o che i j'arspòndo",
	'prefs-lqt' => 'Discussion',
	'lqt-preference-display-depth' => "Profondità d'arspòste al pi da mosté:",
	'lqt-preference-display-count' => "Nùmer d'arspòste al pi da mosté:",
	'lqt-preference-custom-signatures' => "Mosta firme përsonalisà d'utent",
...
Sta sì a l'é na notìfica da {{SITENAME}} che na discussion neuva su $5, '$2',
a l'é stàita creà ël $3 a $4.

It peule vëddla su <$6>",
	'lqt-enotif-reply' => "Cerea $1,
Sta sì a l'é na notìfica da {{SITENAME}} che n'arspòsta neuva a '$2' su $5,
a l'é stàita creà ël $3 a $4.

It peule vëddla su <$6>",
	'lqt-quote-intro' => "Ël $2 a $3, [[User:$1|$1]] a l'ha scrivù:",
	'lqt-quote' => 'Sité',
	'lqt-search-legend' => 'Serca discussion dzora a sta pàgina-sì',
	'lqt-search-label' => 'Serca element:',
	'lqt-search-button' => 'Sërca',
	'searchprofile-threads' => 'Discussion',
	'searchprofile-threads-tooltip' => 'Sërca discussion e pàgine ëd discussion',
	'lqt-ajax-updated' => "Sta discussion-sì a l'ha ëd mëssagi neuv.",
	'lqt-ajax-update-link' => 'Agiorna',
	'lqt-thread-show-replies' => 'Mosta $1 {{PLURAL:$1|arspòsta|arspòste}}',
	'lqt-thread-show-more' => 'Mosta pi arspòste',
	'lqt-thread-link-url' => 'Anliura URL:',
	'lqt-thread-link-title' => 'Colegament ëd test wiki:',
	'lqt-thread-link-copy' => "Còpia ant j'anotassion",
	'lqt-sign-not-necessary' => "A-i é pa dabzògn ëd firmé tò mëssagi con quatr tilde.
La firma a l'é mostà automaticament.",
	'lqt-marked-as-read-placeholder' => "La discussion $1 a l'é stàita marcà com lesùa.",
	'lqt-change-subject' => 'Cangia soget',
	'lqt-save-subject' => 'Salva',
	'lqt-save-subject-failed' => "L'eror sota a l'é capità an mente as provava a cangé ël soget dë sta discussion-sì: $1",
	'lqt-ajax-invalid-subject' => "Ël soget ch'it l'has specificà a l'é pa bon, miraco përchè a l'é tròp longh.",
	'lqt-ajax-no-subject' => 'It deuve specifiché un soget.',
	'lqt-save-subject-error-unknown' => 'N\'eror pa conossù a l\'é capità an provand a amposté ël soget dë sta discussion-sì. Për piasì preuva a fé sòn sì an sgnacand "modìfica" dzora al prim mëssagi.',
	'lqt-cancel-subject-edit' => 'Scancela',
	'lqt-drag-activate' => 'Tira a la locassion neuva',
	'lqt-drag-drop-zone' => 'Sàuta sì',
	'lqt-drag-confirm' => 'Për completé j\'assion sota, për piasì vemp na rason e sgnaca "Confirma".',
	'lqt-drag-reparent' => 'Tramuda mëssagi sota un genitor neuv.',
	'lqt-drag-split' => 'Tramuda mëssagi a soa discussion',
	'lqt-drag-setsortkey' => 'Rangia posission dël mëssagi an sla pàgina',
	'lqt-drag-bump' => 'Tramuda mëssagi a la sima dla pàgina ëd discussion',
	'lqt-drag-save' => 'Conferma',
	'lqt-drag-reason' => 'Rason:',
	'lqt-drag-subject' => 'Soget për discussion neuva:',
	'lqt-edit-signature' => '(modìfica firma)',
	...
	'lqt-talkpage-history-subtitle' => 'Pës $1',
	'lqt-talkpage-history-tab' => 'Testà',
	'restriction-reply' => 'Manda arspòste',
	'restriction-newthread' => 'Manda discussion neuva',
	'lqt-protected-reply-thread' => "It peule pa mandé su sta discussion-sì përchè a l'é stàita proteta da mëssagi neuv.",
	'lqt-protected-reply-talkpage' => "It peule pa mandé su sta discussion-sì përchè sta pàgina ëd discussion-sì a l'é stàita proteta da arspòste a soe discussion.",
	'lqt-protected-newthread' => "It peule pa mandé discussion neuve su sta pàgina ëd discussion-sì përchè a l'é stàita proteta da discussion neuve.",
	'lqt-edit-bump' => 'Colpiss sta discussion-sì',
	'lqt-edit-bump-tooltip' => 'Tramuda sta discussion-sì a la sima ëd soa pàgina ëd discussion',
	'lqt-historicalrevision-error' => "La revision ch'it l'has selessionà a l'é brecà, e a peul pa esse vëddùa.",
