...
Подпіс паказваецца аўтаматычна.',
	...
	'lqt-drag-confirm' => 'Для сканчэньня новага дзеяньня, калі ласка пазначце прычыну і націсьніце «{{int:lqt-drag-save}}».',
...
Pódpis pokazujo se awtomatiski.',
	...
	'lqt-drag-confirm' => 'Aby wuwjadł slědujuce akcije, zapiš pšosym pśicynu a klikni na "{{int:lqt-drag-save}}".',
...
La signature est affichée automatiquement.",
	...
	'lqt-drag-confirm' => 'Pour finir les actions suivantes, merci de remplir le champ Raison et de cliquer sur « {{int:lqt-drag-save}} ».',
...
Pode vela en <$6>',
	...
	'lqt-drag-confirm' => 'Para completar as seguintes accións, por favor, encha o motivo e prema en "{{int:lqt-drag-save}}".',
...
D Signatur wird automatisch aazeigt.',
	...
	'lqt-drag-confirm' => 'Go die Aktione abschließe gib bitte ne Grund aa un druck uf „{{int:lqt-drag-save}}“.',
...
Podpis pokazuje so awtomatisce.',
	...
	'lqt-drag-confirm' => 'Zo by slědowace akcije wuwjedł, zapisaj prošu přičinu a klikń na "{{int:lqt-drag-save}}".',
...
<$6> で確認できます。',
	...
	'lqt-drag-confirm' => '以下の操作を完了するには、理由を記入し「{{int:lqt-drag-save}}」をクリックしてください。',
...
De „Ongerschreff“ weed automattesch jezeijsch.',
	...
	'lqt-drag-confirm' => 'Öm dat fäädesch ze maache, wat heh dronger opjelėß es, donn jät bei „Jrond“ enfölle, un donn dann „{{int:lqt-drag-save}}“ klecke.',
...
Podpis jest wyświetlany automatycznie.',
	...
	'lqt-ajax-invalid-subject' => 'Podano nieprawidłowy temat; może on być zbyt długi.',
	...
	'lqt-edit-bump-tooltip' => 'Przesuń wątek na szczyt strony dyskusji',
	'lqt-historicalrevision-error' => 'Wybrana przez Ciebie wersja jest nieprawidłowa i nie można jej wyświetlić.',
);
...
A assinatura é apresentada automaticamente.',
	...
	'lqt-cancel-subject-edit' => 'Cancelar',
	'lqt-drag-confirm' => 'Para concluir as seguintes operações, por favor, preencha o motivo e clique "{{int:lqt-drag-save}}".',
...
La firma la vien fora da sola.',
	...
	'lqt-drag-confirm' => 'Par conpletar le seguenti azion, par piaser inserissi un motivo e struca "{{int:lqt-drag-save}}".',
